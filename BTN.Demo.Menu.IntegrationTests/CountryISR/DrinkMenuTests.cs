...
namespace BTN.Demo.Menu.IntegrationTests.CountryISR
{
    [TestClass]
    public class DrinkMenuTests : BaseIntegrationTests
    {
        ...
        public static async Task Initialize(TestContext context)
        {
            ...
            configValues = new Dictionary<string, string>() { { "CountryConfigurationOptions:CountryCode", "ISR" } };
            await Initialize();
        }
        ...
        public async Task DrinkMenu_Get_Request_Retruns_Returns_Beers_When_Age18()
        {
            ...
            Assert.AreEqual(0, drinksMenu.Where(drink => drink.BrandName == "Cigar City").Count());
            Assert.AreEqual(0, drinksMenu.Where(drink => drink.BrandName == "The Crown Group").Count());
        }
        ...
        public async Task DrinkMenu_Get_Request_Retruns_Returns_Beers_When_Age21()
        {
            ...
            Assert.AreEqual(0, drinksMenu.Where(drink => drink.BrandName == "The Strong Stuff Company").Count());
        }
    }
}
